...
var App = function(props) {
	...
	haxe_Log.trace(App.modalBox,{ fileName : "src/App.hx", lineNumber : 106, className : "App", methodName : "new"});
	...
	if(!(this.state.appWare.user.user_name == "" || this.state.appWare.user.jwt == "")) {
		haxe_Log.trace("clientVerify",{ fileName : "src/App.hx", lineNumber : 113, className : "App", methodName : "new"});
		...
		var bL4 = view_shared_io_BinaryLoader.create(bL,{ user_name : bL1, jwt : bL2, className : "auth.User", action : "clientVerify", filter : bL3, dataSource : haxe_Serializer.run(_g2), devIP : App.devIP},function(data) {
		...
		haxe_Log.trace("LOGIN required",{ fileName : "src/App.hx", lineNumber : 149, className : "App", methodName : "new"});
		App.store.dispatch(redux__$Redux_Action_$Impl_$.map(action_AppAction.LoginRequired(this.state.appWare.user)));
	}
	haxe_Log.trace(this.state.appWare.user.jwt,{ fileName : "src/App.hx", lineNumber : 155, className : "App", methodName : "new"});
	haxe_Log.trace(Reflect.fields(this.state),{ fileName : "src/App.hx", lineNumber : 158, className : "App", methodName : "new"});
};
$hxClasses["App"] = App;
App.__name__ = "App";
App.edump = function(el) {
	me_cunity_debug_Out.dumpObject(el,{ fileName : "src/App.hx", lineNumber : 180, className : "App", methodName : "edump"});
	return "OK";
};
App.await = function(delay,check,cb) {
	var max = 15;
	var ti = haxe_Timer.delay(function() {
		haxe_Log.trace(max,{ fileName : "src/App.hx", lineNumber : 197, className : "App", methodName : "await"});
		max -= 1;
		if(max + 1 < 0) {
			return;
		}
	...
	haxe_Log.trace(max,{ fileName : "src/App.hx", lineNumber : 205, className : "App", methodName : "await"});
	return ti;
};
App.initEState = function(e) {
	var fS = { clean : true, hasError : false, mounted : false, sideMenu : { }};
	if(e != null) {
		var _g = 0;
		var _g1 = Reflect.fields(e);
		while(_g < _g1.length) {
			var f = _g1[_g];
			++_g;
			fS[f] = Reflect.field(e,f);
		}
	}
	return fS;
};
App.jsxDump = function(el) {
	me_cunity_debug_Out.dumpObject(el,{ fileName : "src/App.hx", lineNumber : 230, className : "App", methodName : "jsxDump"});
	return "OK";
};
App.logOut = function() {
	js_Cookie.set("user.jwt","",-10,"/");
	haxe_Log.trace(js_Cookie.all(),{ fileName : "src/App.hx", lineNumber : 238, className : "App", methodName : "logOut"});
...
App.queryString2 = function(params) {
	...
	haxe_Log.trace(query,{ fileName : "src/App.hx", lineNumber : 257, className : "App", methodName : "queryString2"});
	return query;
};
App.__super__ = React_Component;
App.prototype = $extend(React_Component.prototype,{
	componentDidMount: function() {
		haxe_Log.trace("yeah",{ fileName : "src/App.hx", lineNumber : 164, className : "App", methodName : "componentDidMount"});
	}
	,componentDidCatch: function(error,info) {
		haxe_Log.trace(error,{ fileName : "src/App.hx", lineNumber : 171, className : "App", methodName : "componentDidCatch"});
	}
	,componentDidUpdate: function(prevProps,prevState) {
		haxe_Log.trace("...",{ fileName : "src/App.hx", lineNumber : 176, className : "App", methodName : "componentDidUpdate"});
	}
	,render: function() {
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(React_Fragment), props : { children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(redux_react_Provider), props : { store : App.store, children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_intl_comp_IntlProvider), props : { locale : "de", children : { "$$typeof" : $$tre, type : view_UiView._connected, props : { }, key : null, ref : null}}, key : null, ref : null}}, key : null, ref : null}}, key : null, ref : null};
	}
	,__class__: App
});
...
Go.render = function(root) {
	...
	haxe_Log.trace("GO",{ fileName : "src/Go.hx", lineNumber : 47, className : "Go", methodName : "render"});
};
...
var action_async_UserAction = function() { };
$hxClasses["action.async.UserAction"] = action_async_UserAction;
action_async_UserAction.__name__ = "action.async.UserAction";
action_async_UserAction.loginReq = function(props,requests) {
	return redux_thunk_Thunk.Action(function(dispatch,getState) {
		haxe_Log.trace(props,{ fileName : "src/action/async/UserAction.hx", lineNumber : 37, className : "action.async.UserAction", methodName : "loginReq"});
		...
		haxe_Log.trace(spin,{ fileName : "src/action/async/UserAction.hx", lineNumber : 42, className : "action.async.UserAction", methodName : "loginReq"});
		...
		var bL2 = view_shared_io_BinaryLoader.create(bL,{ user_name : props1, jwt : props2, className : "auth.User", action : "login", filter : bL1, dataSource : haxe_Serializer.run(_g2), pass : props.pass, devIP : App.devIP},function(data) {
			haxe_Log.trace(data,{ fileName : "src/action/async/UserAction.hx", lineNumber : 64, className : "action.async.UserAction", methodName : "loginReq"});
			if(data.dataErrors.keys().hasNext()) {
				var _this = data.dataErrors;
				var bL3 = action_AppAction.LoginError({ user_name : props.user_name, loginError : new haxe_ds__$StringMap_StringMapIterator(_this,_this.arrayKeys()).next()});
				return dispatch(redux__$Redux_Action_$Impl_$.map(bL3));
			}
			var _this1 = data.dataInfo;
			var uState = __map_reserved["user_data"] != null ? _this1.getReserved("user_data") : _this1.h["user_data"];
			js_Cookie.set("user.user_name",props.user_name,null,"/");
			js_Cookie.set("user.jwt",uState.jwt,null,"/");
			haxe_Log.trace(js_Cookie.get("user.jwt"),{ fileName : "src/action/async/UserAction.hx", lineNumber : 72, className : "action.async.UserAction", methodName : "loginReq"});
			uState.loggedIn = true;
			return dispatch(redux__$Redux_Action_$Impl_$.map(action_AppAction.LoginComplete(uState)));
		});
		if(requests != null) {
			requests.push(haxe_ds_Either.Right(bL2));
		}
		return null;
	});
};
...
model_ApplicationStore.create = function() {
	var appWare = new reduce_AppStore();
	var locationStore = new reduce_LocationStore();
	var statusBarStore = new reduce_StatusBarStore();
	var rootReducer = redux_Redux.combineReducers({ appWare : redux_StoreBuilder.mapReducer(action_AppAction,appWare), locationStore : redux_StoreBuilder.mapReducer(action_LocationAction,locationStore), statusBar : redux_StoreBuilder.mapReducer(action_StatusAction,statusBarStore)});
...
model_CState.confirmTransition = function(message,callback) {
	haxe_Log.trace(message,{ fileName : "src/model/CState.hx", lineNumber : 22, className : "model.CState", methodName : "confirmTransition"});
...
reduce_AppStore.prototype = {
	...
	,reduce: function(state,action) {
		...
		case 2:
			...
			haxe_Log.trace(uState1.user_name + ":" + (uState1.loggedIn == null ? "null" : "" + uState1.loggedIn),{ fileName : "src/reduce/AppStore.hx", lineNumber : 98, className : "reduce.AppStore", methodName : "reduce"});
			uState1.loginError = null;
			uState1.loggedIn = true;
		...
		case 4:
			...
			haxe_Log.trace(err,{ fileName : "src/reduce/AppStore.hx", lineNumber : 88, className : "reduce.AppStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,{ user : { loginError : err.loginError, waiting : false}});
		case 5:
			var uState2 = action.state;
			haxe_Log.trace(uState2,{ fileName : "src/reduce/AppStore.hx", lineNumber : 107, className : "reduce.AppStore", methodName : "reduce"});
			return react_ReactUtil.copy(state,{ user : uState2});
		case 6:
			var uState3 = action.state;
			haxe_Log.trace(uState3,{ fileName : "src/reduce/AppStore.hx", lineNumber : 82, className : "reduce.AppStore", methodName : "reduce"});
		...
		case 9:
			...
			haxe_Log.trace(state.user,{ fileName : "src/reduce/AppStore.hx", lineNumber : 129, className : "reduce.AppStore", methodName : "reduce"});
	...
	,middleware: function(action1,next) {
		haxe_Log.trace(action1,{ fileName : "src/reduce/AppStore.hx", lineNumber : 141, className : "reduce.AppStore", methodName : "middleware"});
		switch(action1._hx_index) {
		case 2:
			var state = action1.state;
			return next();
		case 4:
			var err = action1.state;
			haxe_Log.trace(err,{ fileName : "src/reduce/AppStore.hx", lineNumber : 156, className : "reduce.AppStore", methodName : "middleware"});
			return this.store.dispatch(redux__$Redux_Action_$Impl_$.map(action_AppAction.LoginRequired(this.store.getState().appWare.user)));
		default:
			return next();
		}
	}
	,__class__: reduce_AppStore
};
var reduce_LocationStore = function() {
	this.initState = { history : null, location : null};
	haxe_Log.trace("ok",{ fileName : "src/reduce/LocationStore.hx", lineNumber : 39, className : "reduce.LocationStore", methodName : "new"});
};
$hxClasses["reduce.LocationStore"] = reduce_LocationStore;
reduce_LocationStore.__name__ = "reduce.LocationStore";
reduce_LocationStore.__interfaces__ = [redux_IMiddleware,redux_IReducer];
reduce_LocationStore.prototype = {
	initState: null
	,store: null
	,reduce: function(state,action) {
		switch(action._hx_index) {
		...
		case 6:
			...
			haxe_Log.trace(location.pathname,{ fileName : "src/reduce/LocationStore.hx", lineNumber : 51, className : "reduce.LocationStore", methodName : "reduce"});
	...
	,middleware: function(action,next) {
		haxe_Log.trace(action,{ fileName : "src/reduce/LocationStore.hx", lineNumber : 62, className : "reduce.LocationStore", methodName : "middleware"});
		return next();
	}
	,__class__: reduce_LocationStore
};
var reduce_StatusBarStore = function() {
	this.initState = { pathname : window.location.pathname, date : new Date()};
	haxe_Log.trace("ok",{ fileName : "src/reduce/StatusBarStore.hx", lineNumber : 41, className : "reduce.StatusBarStore", methodName : "new"});
};
$hxClasses["reduce.StatusBarStore"] = reduce_StatusBarStore;
reduce_StatusBarStore.__name__ = "reduce.StatusBarStore";
reduce_StatusBarStore.__interfaces__ = [redux_IReducer];
reduce_StatusBarStore.prototype = {
	initState: null
	,reduce: function(state,action) {
		haxe_Log.trace(state,{ fileName : "src/reduce/StatusBarStore.hx", lineNumber : 46, className : "reduce.StatusBarStore", methodName : "reduce"});
		var date = action.date;
		haxe_Log.trace(date,{ fileName : "src/reduce/StatusBarStore.hx", lineNumber : 50, className : "reduce.StatusBarStore", methodName : "reduce"});
		return react_ReactUtil.copy(state,{ date : date});
	}
	,__class__: reduce_StatusBarStore
};
...
view_Accounting.mapStateToProps = function() {
	return function(aState) {
		...
		return { appConfig : aState.appWare.config, user : uState, redirectAfterLogin : aState.appWare.redirectAfterLogin};
	};
};
...
view_Contacts.mapStateToProps = function() {
	return function(aState) {
		var uState = aState.appWare.user;
		return { appConfig : aState.appWare.config, redirectAfterLogin : aState.appWare.redirectAfterLogin, user : uState};
	};
};
...
view_Contacts.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/Contacts.hx", lineNumber : 74, className : "view.Contacts", methodName : "render"});
		haxe_Log.trace(this.props.history.location.pathname,{ fileName : "src/view/Contacts.hx", lineNumber : 75, className : "view.Contacts", methodName : "render"});
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/Contacts.hx", lineNumber : 77, className : "view.Contacts", methodName : "render"});
...
var view_DashBoard = function(props) {
	...
	haxe_Log.trace("location.pathname:" + Std.string(props.history.location.pathname) + " match.url: " + Std.string(props.match.url) + " user:" + Std.string(props.user),{ fileName : "src/view/DashBoard.hx", lineNumber : 48, className : "view.DashBoard", methodName : "new"});
	React_Component.call(this,props);
	if(props.match.url == "/DashBoard") {
		props.history.push("/DashBoard/Settings");
		haxe_Log.trace("pushed2: /DashBoard/Settings",{ fileName : "src/view/DashBoard.hx", lineNumber : 53, className : "view.DashBoard", methodName : "new"});
	}
};
...
view_DashBoard.mapStateToProps = function(aState) {
	var uState = aState.appWare.user;
	haxe_Log.trace(uState.first_name,{ fileName : "src/view/DashBoard.hx", lineNumber : 91, className : "view.DashBoard", methodName : "mapStateToProps"});
	return { appConfig : aState.appWare.config, redirectAfterLogin : aState.appWare.redirectAfterLogin, user : uState};
};
...
view_DashBoard.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/DashBoard.hx", lineNumber : 69, className : "view.DashBoard", methodName : "componentDidCatch"});
		haxe_Log.trace(info,{ fileName : "src/view/DashBoard.hx", lineNumber : 70, className : "view.DashBoard", methodName : "componentDidCatch"});
	}
	,componentWillUnmount: function() {
		haxe_Log.trace("leaving...",{ fileName : "src/view/DashBoard.hx", lineNumber : 75, className : "view.DashBoard", methodName : "componentWillUnmount"});
		return;
	}
	,render: function() {
		var _gthis = this;
		haxe_Log.trace(this.props.user,{ fileName : "src/view/DashBoard.hx", lineNumber : 117, className : "view.DashBoard", methodName : "render"});
		...
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/DashBoard.hx", lineNumber : 120, className : "view.DashBoard", methodName : "render"});
		haxe_Log.trace(Reflect.fields(this.state),{ fileName : "src/view/DashBoard.hx", lineNumber : 121, className : "view.DashBoard", methodName : "render"});
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(React_Fragment), props : { children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "tabNav2", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(bulma_$components_Tabs), props : { boxed : true, children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("ul"), props : { children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps($bind(this,this.TabLink)), props : Object.assign({ },this.props,{ to : "/DashBoard/Roles", children : "Benutzer"}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps($bind(this,this.TabLink)), props : Object.assign({ },this.props,{ to : "/DashBoard/Settings", children : "Meine Einstellungen"}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps($bind(this,this.TabLink)), props : Object.assign({ },this.props,{ to : "/DashBoard/Setup", children : "Setup"}), key : null, ref : null}]}, key : null, ref : null}}, key : null, ref : null}}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "tabContent2", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/DashBoard/Roles/:section?/:action?/:id?", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_dashboard_Roles)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/DashBoard/Settings/:section?/:action?/:id?", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_dashboard_Settings)}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/DashBoard/Setup/:section?/:action?", render : function(p) {
			return _gthis.renderComponent(view_dashboard_Setup,p,_gthis.props.user);
		}}, key : null, ref : null}]}, key : null, ref : null},{ "$$typeof" : $$tre, type : view_StatusBar._connected, props : this.props, key : null, ref : null}]}, key : null, ref : null};
	}
	,renderComponent: function(Comp,props,user) {
		haxe_Log.trace(user.first_name,{ fileName : "src/view/DashBoard.hx", lineNumber : 150, className : "view.DashBoard", methodName : "renderComponent"});
		props.user = user;
		switch(Comp) {
		case view_dashboard_Roles:
			return { "$$typeof" : $$tre, type : view_dashboard_Roles._connected, props : Object.assign({ },props,{ user : this.props.user}), key : null, ref : null};
		case view_dashboard_Setup:
			return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(view_dashboard_Setup), props : Object.assign({ },props,{ user : this.props.user}), key : null, ref : null};
		default:
			return null;
		}
	}
...
var view_LoginForm = function(props) {
	React_Component.call(this,props);
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/LoginForm.hx", lineNumber : 55, className : "view.LoginForm", methodName : "new"});
	if(props.match != null) {
		haxe_Log.trace(props.match.path + ":" + props.match.url,{ fileName : "src/view/LoginForm.hx", lineNumber : 58, className : "view.LoginForm", methodName : "new"});
	}
	haxe_Log.trace(props,{ fileName : "src/view/LoginForm.hx", lineNumber : 60, className : "view.LoginForm", methodName : "new"});
...
view_LoginForm.mapStateToProps = function() {
	return function(aState) {
		var uState = aState.appWare.user;
		haxe_Log.trace(uState,{ fileName : "src/view/LoginForm.hx", lineNumber : 83, className : "view.LoginForm", methodName : "mapStateToProps"});
...
view_LoginForm.prototype = $extend(React_Component.prototype,{
	handleChange: function(e) {
		var s = { };
		var t = e.target;
		haxe_Log.trace(t.name,{ fileName : "src/view/LoginForm.hx", lineNumber : 105, className : "view.LoginForm", methodName : "handleChange"});
		haxe_Log.trace(t.value,{ fileName : "src/view/LoginForm.hx", lineNumber : 106, className : "view.LoginForm", methodName : "handleChange"});
		s[t.name] = t.value;
		this.setState(s);
	}
	...
	,render: function() {
		haxe_Log.trace(Reflect.fields(this.props),{ fileName : "src/view/LoginForm.hx", lineNumber : 131, className : "view.LoginForm", methodName : "render"});
		...
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("section"), props : { className : "hero is-alt is-fullheight", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "formContainer", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "formBox is-rounded", style : style, children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "logo", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("img"), props : { src : "img/schutzengelwerk-logo.png", style : { width : "100%"}}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("h2"), props : { className : "overlaySubTitle", children : "crm 2.0"}, key : null, ref : null}]}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "form2", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("form"), props : { name : "form", onSubmit : $bind(this,this.handleSubmit), children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "formField", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("label"), props : { className : "userIcon", forhtml : "login_user_name", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("span"), props : { className : "hidden", children : "User ID"}, key : null, ref : null}}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("input"), props : { id : "login_user_name", name : "user_name", className : this.errorStyle("user_name") + "form-input", placeholder : "User ID", value : this.state.user_name, onChange : $bind(this,this.handleChange)}, key : null, ref : null}]}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "formField", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("label"), props : { className : "lockIcon", forhtml : "login_pass", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("span"), props : { className : "hidden", children : "Password"}, key : null, ref : null}}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("input"), props : { id : "login_pass", className : this.errorStyle("pass") + "form-input", name : "pass", type : "password", placeholder : "Password", value : this.state.pass, onChange : $bind(this,this.handleChange)}, key : null, ref : null}]}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "formField", children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("input"), props : { type : "submit", value : "Login"}, key : null, ref : null}}, key : null, ref : null}]}, key : null, ref : null}}, key : null, ref : null}]}, key : null, ref : null}}, key : null, ref : null}}, key : null, ref : null};
	}
	,errorStyle: function(name) {
		...
		case "pass":
			...
			haxe_Log.trace(res,{ fileName : "src/view/LoginForm.hx", lineNumber : 190, className : "view.LoginForm", methodName : "errorStyle"});
			eStyle = res;
			break;
		case "user_name":
		...
		haxe_Log.trace(eStyle,{ fileName : "src/view/LoginForm.hx", lineNumber : 199, className : "view.LoginForm", methodName : "errorStyle"});
		return eStyle;
	}
...
var view_StatusBar = function(props,context) {
	...
	haxe_Log.trace("ok",{ fileName : "src/view/StatusBar.hx", lineNumber : 54, className : "view.StatusBar", methodName : "new"});
	React_Component.call(this,props);
};
...
view_StatusBar.mapStateToProps = function(state) {
	haxe_Log.trace(state.appWare.user.first_name,{ fileName : "src/view/StatusBar.hx", lineNumber : 97, className : "view.StatusBar", methodName : "mapStateToProps"});
...
view_StatusBar.mapDispatchToProps = function(dispatch,ownProps) {
	haxe_Log.trace(ownProps.date,{ fileName : "src/view/StatusBar.hx", lineNumber : 108, className : "view.StatusBar", methodName : "mapDispatchToProps"});
	return { };
};
...
view_StatusBar.prototype = $extend(React_Component.prototype,{
	...
	,componentDidMount: function() {
		...
		haxe_Timer.delay(function() {
			if(!_gthis.mounted) {
				haxe_Log.trace("not mounted - will do nothing",{ fileName : "src/view/StatusBar.hx", lineNumber : 74, className : "view.StatusBar", methodName : "componentDidMount"});
				return;
			}
			haxe_Log.trace("timer start at " + new Date().getSeconds(),{ fileName : "src/view/StatusBar.hx", lineNumber : 77, className : "view.StatusBar", methodName : "componentDidMount"});
	...
	,render: function() {
		...
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(bulma_$components_Footer), props : { children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "statusbar", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("span"), props : { className : "column", children : [" Pfad: ",this.props.pathname]}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("span"), props : { className : "column", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("i"), props : { className : userIcon}, key : null, ref : null}," ",user_name]}, key : null, ref : null},{ "$$typeof" : $$tre, type : view_shared_DateTime._renderWrapper, props : { }, key : null, ref : null}]}, key : null, ref : null}}, key : null, ref : null};
	}
	,DateTimeClock: function(p) {
		haxe_Log.trace(p,{ fileName : "src/view/StatusBar.hx", lineNumber : 138, className : "view.StatusBar", methodName : "DateTimeClock"});
		return null;
	}
...
var view_UiView = function(props) {
	this.tabList = [];
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/UiView.hx", lineNumber : 81, className : "view.UiView", methodName : "new"});
	haxe_Log.trace(props.store == App.store,{ fileName : "src/view/UiView.hx", lineNumber : 82, className : "view.UiView", methodName : "new"});
	React_Component.call(this,props);
...
view_UiView.mapStateToProps = function(aState) {
	haxe_Log.trace(aState.appWare.user,{ fileName : "src/view/UiView.hx", lineNumber : 74, className : "view.UiView", methodName : "mapStateToProps"});
...
view_UiView.prototype = $extend(React_Component.prototype,{
	...
	,componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/UiView.hx", lineNumber : 99, className : "view.UiView", methodName : "componentDidCatch"});
	}
	,componentDidMount: function() {
		this.mounted = true;
	}
	...
	,render: function() {
		haxe_Log.trace(this.props.user.jwt + ":" + Std.string(this.props.user.waiting),{ fileName : "src/view/UiView.hx", lineNumber : 135, className : "view.UiView", methodName : "render"});
		if(this.state.hasError) {
		...
		if(this.props.user.jwt == null || this.props.user.jwt == "" || !this.props.user.loggedIn) {
			return { "$$typeof" : $$tre, type : view_LoginForm._connected, props : this.props.user, key : null, ref : null};
		} else {
			haxe_Log.trace("render Router :)" + this.browserHistory.location.pathname,{ fileName : "src/view/UiView.hx", lineNumber : 158, className : "view.UiView", methodName : "render"});
			return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Router), props : { history : this.browserHistory, children : { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(React_Fragment), props : { children : [React.createElement(react__$ReactType_ReactType_$Impl_$.fromString("div"),{ ref : App.modalBox, className : "modal"}),{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "topNav", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/DashBoard", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_NavTabs)}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/accounting", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_NavTabs)}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/contacts", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_NavTabs)}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/qc", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_NavTabs)}), key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : Object.assign({ },this.props,{ path : "/reports", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_NavTabs)}), key : null, ref : null}]}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "tabComponent", children : [{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_RedirectBox), exact : true}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/DashBoard*", component : react__$ReactType_ReactType_$Impl_$.fromComp(view_DashBoard)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/accounting", component : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps(react_router_bundle_BundleLoader2.render)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/contacts/edit/:id", component : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps(react_router_bundle_BundleLoader4.render)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/contacts", component : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps(react_router_bundle_BundleLoader6.render)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/qc", component : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps(react_router_bundle_BundleLoader8.render)}, key : null, ref : null},{ "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(react_router_Route), props : { path : "/reports", component : react__$ReactType_ReactType_$Impl_$.fromFunctionWithProps(react_router_bundle_BundleLoader10.render)}, key : null, ref : null}]}, key : null, ref : null}]}, key : null, ref : null}}, key : null, ref : null};
		}
	}
...
var view_dashboard_Roles = function(props) {
	React_Component.call(this,props);
	this.state = { clean : true, hasError : false, mounted : false, loading : true, sideMenu : view_shared_io_FormFunctions.initSideMenu(this,[{ dataClassPath : "roles.User", label : "Benutzer", section : "Users", items : view_shared_io_Users.menuItems},{ dataClassPath : "settings.Bookmarks", label : "Benutzergruppen", section : "Bookmarks", items : []},{ dataClassPath : "roles.Permissions", label : "Rechte", section : "permissions", items : []}],{ section : "Users", sameWidth : true})};
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 72, className : "view.dashboard.Roles", methodName : "new"});
};
...
view_dashboard_Roles.mapStateToProps = function(aState) {
	return function(aState1) {
		...
		haxe_Log.trace(uState,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 136, className : "view.dashboard.Roles", methodName : "mapStateToProps"});
		return { user : uState};
	};
};
...
view_dashboard_Roles.prototype = $extend(React_Component.prototype,{
	...
	,importExternalUsers: function(ev) {
		haxe_Log.trace(ev.currentTarget,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 116, className : "view.dashboard.Roles", methodName : "importExternalUsers"});
		this.props.formContainer.requests.push(haxe_ds_Either.Left(model_AjaxLoader.load("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, first_name : this.props.user.first_name, className : "admin.CreateUsers", action : "importExternal"},function(data) {
			haxe_Log.trace(data,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 127, className : "view.dashboard.Roles", methodName : "importExternalUsers"});
		})));
	}
	,componentDidMount: function() {
		var _gthis = this;
		haxe_Log.trace(this.state.loading,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 146, className : "view.dashboard.Roles", methodName : "componentDidMount"});
		var tmp = "" + Std.string(App.config.api);
		var tmp1 = this.props.user.user_name;
		var tmp2 = this.props.user.jwt;
		...
		view_shared_io_BinaryLoader.create(tmp,{ user_name : tmp1, jwt : tmp2, className : "roles.Users", action : "list", filter : "active|TRUE", dataSource : haxe_Serializer.run(_g3), devIP : App.devIP},function(data) {
			haxe_Log.trace(Reflect.fields(data),{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 173, className : "view.dashboard.Roles", methodName : "componentDidMount"});
			haxe_Log.trace(data.dataRows[0].toString(),{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 175, className : "view.dashboard.Roles", methodName : "componentDidMount"});
	...
	,render: function() {
		...
		if(sM.menuBlocks != null) {
			haxe_Log.trace(sM.menuBlocks.keys().next() + ":" + this.props.match.params.section,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 203, className : "view.dashboard.Roles", methodName : "render"});
		}
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("div"), props : { className : "columns", children : [this.renderContent(),{ "$$typeof" : $$tre, type : view_shared_SMenu._connected, props : Object.assign({ },sM,{ className : "menu"}), key : null, ref : null}]}, key : null, ref : null};
	}
	,renderContent: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/dashboard/Roles.hx", lineNumber : 215, className : "view.dashboard.Roles", methodName : "renderContent"});
	...
	,renderContent: function(cState) {
		...
		if(_g == null) {
			...
			case "Bookmarks":
				return { "$$typeof" : $$tre, type : view_shared_io_Bookmarks._connected, props : Object.assign({ },this.props,{ sideMenu : this.state.sideMenu, formContainer : cState.formContainer, fullWidth : true}), key : null, ref : null};
			case "User":
				return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromComp(view_shared_io_User), props : Object.assign({ },this.props,{ sideMenu : this.state.sideMenu, formContainer : cState.formContainer, fullWidth : true}), key : null, ref : null};
			default:
				return null;
			}
		}
...
var view_dashboard_Setup = function(props) {
	haxe_Log.trace(props.user,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 42, className : "view.dashboard.Setup", methodName : "new"});
	React_Component.call(this,props);
	...
	haxe_Log.trace(Reflect.fields(props),{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 71, className : "view.dashboard.Setup", methodName : "new"});
};
...
view_dashboard_Setup.prototype = $extend(React_Component.prototype,{
	componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 93, className : "view.dashboard.Setup", methodName : "componentDidCatch"});
	}
	,componentDidMount: function() {
		...
		if(this.props.match.params.section == null) {
			...
			haxe_Log.trace(this.props.history.location.pathname,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 104, className : "view.dashboard.Setup", methodName : "componentDidMount"});
			haxe_Log.trace("setting section to:DB",{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 105, className : "view.dashboard.Setup", methodName : "componentDidMount"});
		}
		haxe_Log.trace("",{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 108, className : "view.dashboard.Setup", methodName : "componentDidMount"});
	}
	,render: function() {
		if(this.state.sideMenu != { }) {
			if(this.state.sideMenu.menuBlocks != null) {
				haxe_Log.trace(Std.string(($_=this.state.sideMenu.menuBlocks.keys(),$bind($_,$_.next))) + ":" + this.state.sideMenu.section,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 135, className : "view.dashboard.Setup", methodName : "render"});
			}
		}
		return view_shared_io_FormFunctions.render(this);
	}
	,renderContent: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 148, className : "view.dashboard.Setup", methodName : "renderContent"});
	...
	,switchContent: function(reactEventSource) {
		haxe_Log.trace(this.state,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 167, className : "view.dashboard.Setup", methodName : "switchContent"});
		var section = reactEventSource.target.getAttribute("data-section");
		haxe_Log.trace(section,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 172, className : "view.dashboard.Setup", methodName : "switchContent"});
		if(section != this.props.match.params.section) {
			...
			haxe_Log.trace(this.props.history.location.pathname,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 179, className : "view.dashboard.Setup", methodName : "switchContent"});
			var sM = this.state.sideMenu;
			sM.section = section;
			this.setState({ sideMenu : sM});
			haxe_Log.trace("setting state.sideMenu.section to:" + section,{ fileName : "src/view/dashboard/Setup.hx", lineNumber : 183, className : "view.dashboard.Setup", methodName : "switchContent"});
		}
	}
...
view_shared_SMenu.prototype = $extend(React_Component.prototype,{
	...
	,renderHeader: function() {
		...
		Lambda.iter(this.props.menuBlocks,function(block) {
			...
			i += 1;
			header.push({ "$$typeof" : tmp, type : tmp1, props : { type : "radio", id : "sMenuPanel-" + (i - 1), name : "accordion-select", checked : check, onChange : block.onActivate, 'data-section' : block.section}, key : i, ref : null});
		});
		return header;
	}
	...
	,renderPanel: function(_i,block) {
		var i = _i + 1;
		var style = this.props.sameWidth && this.state.sameWidth > 0 ? { width : "" + this.state.sameWidth + "px"} : null;
	...
	,renderItems: function(items) {
		...
		return Lambda.array(items.map(function(item) {
			...
			i += 1;
			return React.createElement(react__$ReactType_ReactType_$Impl_$.fromComp(bulma_$components_Button),{ key : i - 1, onClick : _gthis.props.itemHandler, 'data-action' : item.action, disabled : item.disabled},item.label);
		}));
	}
	,render: function() {
...
view_shared_io_Bookmarks.prototype = $extend(React_Component.prototype,{
	componentDidCatch: function(error,info) {
		...
		haxe_Log.trace(error,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 41, className : "view.shared.io.Bookmarks", methodName : "componentDidCatch"});
		haxe_Log.trace(info,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 42, className : "view.shared.io.Bookmarks", methodName : "componentDidCatch"});
	}
	,add: function(ev) {
	}
	,'delete': function(ev) {
	...
	,edit: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi :)",{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 57, className : "view.shared.io.Bookmarks", methodName : "edit"});
		this.props.formContainer.requests.push(haxe_ds_Either.Left(model_AjaxLoader.load("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "auth.User", action : "edit", filter : "user_name|" + this.props.user.user_name, dataSource : haxe_Serializer.run(null)},function(data) {
			if(data.rows == null) {
				return;
			}
			haxe_Log.trace(data.rows.length,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 72, className : "view.shared.io.Bookmarks", methodName : "edit"});
			var dataRows = data.rows;
			haxe_Log.trace(Reflect.fields(dataRows[0]),{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 74, className : "view.shared.io.Bookmarks", methodName : "edit"});
			haxe_Log.trace(dataRows[0].active,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 75, className : "view.shared.io.Bookmarks", methodName : "edit"});
			var _g2 = new haxe_ds_StringMap();
	...
	,render: function() {
		haxe_Log.trace(this.state,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 118, className : "view.shared.io.Bookmarks", methodName : "render"});
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 121, className : "view.shared.io.Bookmarks", methodName : "render"});
	...
	,updateMenu: function(viewClassPath) {
		if(this.state == null) {
			haxe_Log.trace(this.state,{ fileName : "src/view/shared/io/Bookmarks.hx", lineNumber : 141, className : "view.shared.io.Bookmarks", methodName : "updateMenu"});
			return null;
		}
...
var view_shared_io_DB = function(props) {
	...
	this.state = { hasError : false, sideMenu : { }};
};
$hxClasses["view.shared.io.DB"] = view_shared_io_DB;
view_shared_io_DB.__name__ = "view.shared.io.DB";
view_shared_io_DB.__super__ = React_Component;
view_shared_io_DB.prototype = $extend(React_Component.prototype,{
	dataDisplay: null
	,dataAccess: null
	,createFieldList: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi :)",{ fileName : "src/view/shared/io/DB.hx", lineNumber : 62, className : "view.shared.io.DB", methodName : "createFieldList"});
		this.props.formContainer.requests.push(haxe_ds_Either.Left(view_shared_io_Loader.load("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "tools.DB", action : "createFieldList", update : "1"},function(data) {
			haxe_Log.trace(data.toString(),{ fileName : "src/view/shared/io/DB.hx", lineNumber : 74, className : "view.shared.io.DB", methodName : "createFieldList"});
			if(__map_reserved["error"] != null ? data.existsReserved("error") : data.h.hasOwnProperty("error")) {
				haxe_Log.trace(__map_reserved["error"] != null ? data.getReserved("error") : data.h["error"],{ fileName : "src/view/shared/io/DB.hx", lineNumber : 77, className : "view.shared.io.DB", methodName : "createFieldList"});
				return;
			}
			_gthis.setState({ data : data});
		})));
		haxe_Log.trace(this.props.history,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 83, className : "view.shared.io.DB", methodName : "createFieldList"});
		haxe_Log.trace(this.props.match,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 84, className : "view.shared.io.DB", methodName : "createFieldList"});
	}
	,editTableFields: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 90, className : "view.shared.io.DB", methodName : "editTableFields"});
		var data = this.props.formContainer.selectedRowsMap();
		...
		haxe_Log.trace(__map_reserved["table_name"] != null ? _this2.getReserved("table_name") : _this2.h["table_name"],{ fileName : "src/view/shared/io/DB.hx", lineNumber : 93, className : "view.shared.io.DB", methodName : "editTableFields"});
		var _this3 = data[0];
		haxe_Log.trace((__map_reserved["id"] != null ? _this3.getReserved("id") : _this3.h["id"]) + "<",{ fileName : "src/view/shared/io/DB.hx", lineNumber : 94, className : "view.shared.io.DB", methodName : "editTableFields"});
		var tmp = this.props.formContainer;
		var tmp1 = new haxe_ds_StringMap();
		var tmp2 = this.initStateFromDataTable(data);
		var _this4 = this.dataAccess;
		tmp.renderModalForm({ data : tmp1, dataTable : data, handleSubmit : $bind(this,this.saveTableFields), hasError : false, isConnected : true, initialState : tmp2, model : "tableFields", fields : view1, valuesArray : this.props.formContainer.createStateValuesArray(data,(__map_reserved["editTableFields"] != null ? _this4.getReserved("editTableFields") : _this4.h["editTableFields"]).view), loading : false, title : "Tabellenfelder Eigenschaften"});
	}
	,initStateFromDataTable: function(dt) {
		...
		while(_g < dt.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				haxe_Log.trace(k1,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 120, className : "view.shared.io.DB", methodName : "initStateFromDataTable"});
		...
		haxe_Log.trace(iS,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 130, className : "view.shared.io.DB", methodName : "initStateFromDataTable"});
		return iS;
	}
	,saveTableFields: function(vA) {
		haxe_Log.trace(vA,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 136, className : "view.shared.io.DB", methodName : "saveTableFields"});
	}
	,showFieldList: function(_) {
		var _gthis = this;
		this.props.formContainer.selectAllRows(true);
		this.props.formContainer.requests.push(haxe_ds_Either.Right(view_shared_io_BinaryLoader.create("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, fields : "id,table_name,field_name,readonly,element,required,use_as_index", className : "tools.DB", action : "createFieldList", devIP : App.devIP},function(data) {
			if(data.dataRows.length == 0) {
				...
				while(eK.hasNext()) {
					hasError = true;
					var key = eK.next();
					haxe_Log.trace(Std.string(__map_reserved[key] != null ? error.getReserved(key) : error.h[key]),{ fileName : "src/view/shared/io/DB.hx", lineNumber : 185, className : "view.shared.io.DB", methodName : "showFieldList"});
				}
				if(!hasError) {
					haxe_Log.trace("Keine Daten!",{ fileName : "src/view/shared/io/DB.hx", lineNumber : 188, className : "view.shared.io.DB", methodName : "showFieldList"});
				}
				return;
			}
			haxe_Log.trace(data.dataRows,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 192, className : "view.shared.io.DB", methodName : "showFieldList"});
			_gthis.setState({ dataTable : data.dataRows});
		})));
	}
	,componentDidMount: function() {
		haxe_Log.trace("Ok",{ fileName : "src/view/shared/io/DB.hx", lineNumber : 204, className : "view.shared.io.DB", methodName : "componentDidMount"});
		var _g2 = new haxe_ds_StringMap();
		var _g = new haxe_ds_StringMap();
	...
	,renderResults: function() {
		if(this.state.data != null) {
			...
			case "showFieldList":
				...
				var _this = this.dataDisplay;
				var tmp4 = __map_reserved["fieldsList"] != null ? _this.getReserved("fieldsList") : _this.h["fieldsList"];
				return { "$$typeof" : tmp, type : tmp1, props : Object.assign({ },tmp2,{ id : "fieldsList", data : tmp3, dataState : tmp4, formContainer : this.props.formContainer, className : "is-striped is-hoverable", fullWidth : true}), key : null, ref : null};
			default:
				return null;
			}
		}
	...
	,render: function() {
		if(this.state.values != null) {
			haxe_Log.trace(this.state.values.toString(),{ fileName : "src/view/shared/io/DB.hx", lineNumber : 259, className : "view.shared.io.DB", methodName : "render"});
		}
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/shared/io/DB.hx", lineNumber : 260, className : "view.shared.io.DB", methodName : "render"});
...
var view_shared_io_DBSync = function(props) {
	...
	haxe_Log.trace("..." + Std.string(Reflect.fields(props)),{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 58, className : "view.shared.io.DBSync", methodName : "new"});
	this.state = App.initEState();
	haxe_Log.trace(this.state,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 60, className : "view.shared.io.DBSync", methodName : "new"});
};
$hxClasses["view.shared.io.DBSync"] = view_shared_io_DBSync;
view_shared_io_DBSync.__name__ = "view.shared.io.DBSync";
view_shared_io_DBSync.__super__ = React_Component;
view_shared_io_DBSync.prototype = $extend(React_Component.prototype,{
	dataDisplay: null
	,dataAccess: null
	,dbData: null
	,dbMetaData: null
	,createFieldList: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi :)",{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 70, className : "view.shared.io.DBSync", methodName : "createFieldList"});
		return;
	}
	,editTableFields: function(ev) {
		haxe_Log.trace(this.state.selectedRows.length,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 98, className : "view.shared.io.DBSync", methodName : "editTableFields"});
	}
	,initStateFromDataTable: function(dt) {
		var iS = { };
		var _g = 0;
		while(_g < dt.length) {
			...
			while(k.hasNext()) {
				var k1 = k.next();
				haxe_Log.trace(k1,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 110, className : "view.shared.io.DBSync", methodName : "initStateFromDataTable"});
				var _this = this.dataDisplay;
				var _this1 = (__map_reserved["fieldsList"] != null ? _this.getReserved("fieldsList") : _this.h["fieldsList"]).columns;
		...
		haxe_Log.trace(iS,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 120, className : "view.shared.io.DBSync", methodName : "initStateFromDataTable"});
		return iS;
	}
	,saveTableFields: function(vA) {
		haxe_Log.trace(vA,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 126, className : "view.shared.io.DBSync", methodName : "saveTableFields"});
		this.dbMetaData = new shared_DBMetaData();
		this.dbMetaData.dataFields = this.dbMetaData.stateToDataParams(vA);
		haxe_Log.trace(this.dbMetaData.dataFields.h[111],{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 130, className : "view.shared.io.DBSync", methodName : "saveTableFields"});
		var s = new hxbit_Serializer();
		return;
	}
	,showUserList: function(_) {
		var _gthis = this;
		view_shared_io_BinaryLoader.create("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, fields : "id,table_name,field_name,readonly,element,required,use_as_index", className : "admin.SyncExternal", action : "syncUserDetails", devIP : App.devIP},function(data) {
			var _this = data.dataRows[data.dataRows.length - 2];
			haxe_Log.trace(__map_reserved["phone_data"] != null ? _this.getReserved("phone_data") : _this.h["phone_data"],{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 167, className : "view.shared.io.DBSync", methodName : "showUserList"});
			_gthis.setState({ dataTable : data.dataRows});
		});
	}
	,componentDidMount: function() {
		...
		this.dataAccess = _g2;
		if(this.props.user != null) {
			haxe_Log.trace("yeah: " + this.props.user.first_name,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 199, className : "view.shared.io.DBSync", methodName : "componentDidMount"});
		}
	...
	,renderResults: function() {
		haxe_Log.trace(this.props.match.params.section + ":" + Std.string(this.state.dataTable != null),{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 214, className : "view.shared.io.DBSync", methodName : "renderResults"});
		if(this.state.dataTable != null) {
			...
			case "showFieldList2":
				var _this = this.dataDisplay;
				haxe_Log.trace(__map_reserved["fieldsList"] != null ? _this.getReserved("fieldsList") : _this.h["fieldsList"],{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 226, className : "view.shared.io.DBSync", methodName : "renderResults"});
				var _this1 = this.state.dataTable[29];
				haxe_Log.trace(Std.string(__map_reserved["id"] != null ? _this1.getReserved("id") : _this1.h["id"]) + "<<<",{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 227, className : "view.shared.io.DBSync", methodName : "renderResults"});
				var tmp = $$tre;
				var tmp1 = react__$ReactType_ReactType_$Impl_$.fromComp(view_table_Table);
				var tmp2 = this.props;
				var tmp3 = this.state.dataTable;
			...
			case "showUserList":
				...
				return { "$$typeof" : tmp5, type : tmp6, props : Object.assign({ },tmp7,{ id : "fieldsList", data : tmp8, dataState : tmp9, formContainer : this.props.formContainer, className : "is-striped is-hoverable", fullWidth : true}), key : null, ref : null};
			default:
				return null;
			}
		}
	...
	,render: function() {
		haxe_Log.trace(this.props.match.params.section,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 244, className : "view.shared.io.DBSync", methodName : "render"});
		return { "$$typeof" : $$tre, type : react__$ReactType_ReactType_$Impl_$.fromString("form"), props : { className : "tabComponentForm", children : this.renderResults()}, key : null, ref : null};
	}
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
		haxe_Log.trace(sideMenu.section,{ fileName : "src/view/shared/io/DBSync.hx", lineNumber : 256, className : "view.shared.io.DBSync", methodName : "updateMenu"});
		var _g = 0;
		var _this = sideMenu.menuBlocks;
...
view_shared_io_Design.prototype = $extend(React_Component.prototype,{
	edit: function(ev) {
		...
		this.props.formContainer.requests.push(haxe_ds_Either.Left(model_AjaxLoader.load("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "auth.User", action : "edit", filter : "user_name|" + this.props.user.user_name},function(data) {
			if(data.rows == null) {
				return;
			}
...
var view_shared_io_FormContainer = function(props) {
	React_Component.call(this,props);
	this.requests = [];
	if(props != null) {
...
view_shared_io_FormContainer.prototype = $extend(React_Component.prototype,{
	requests: null
	,dataAccess: null
	,dbData: null
	,dbMetaData: null
	...
	,itemHandler: function(e) {
		...
		var basePath = this.props.match.path.split("/:")[0];
		this.props.history.push("" + basePath + "/" + this.section + "/" + but.getAttribute("data-action"));
	}
	,callMethod: function(method) {
		var fun = Reflect.field(this,method);
		if(Reflect.isFunction(fun)) {
			fun.apply(this,null);
			return true;
		}
	...
	,componentDidMount: function() {
		...
		this.setState({ mounted : true});
		var c = js_Boot.getClass(this);
		haxe_Log.trace(c.__name__.split(".").pop() + "state.action",{ fileName : "src/view/shared/io/FormContainer.hx", lineNumber : 203, className : "view.shared.io.FormContainer", methodName : "componentDidMount"});
	}
	,componentWillUnmount: function() {
...
view_shared_io_FormFunctions.render = function(comp) {
	...
	if(sM.menuBlocks != null) {
		haxe_Log.trace(sM.menuBlocks.keys().next() + ":" + Std.string(comp.props.match.params.section),{ fileName : "src/view/shared/io/FormFunctions.hx", lineNumber : 263, className : "view.shared.io.FormFunctions", methodName : "render"});
	}
...
var view_shared_io_User = function(props) {
	...
	var value12 = { label : "Letze Anmeldung", readonly : true, displayFormat : view_shared_io_FormContainer.localDate};
...
view_shared_io_User.prototype = $extend(React_Component.prototype,{
	...
	,componentDidMount: function() {
		var _gthis = this;
		var _this = this.dataAccess;
		this.props.formContainer.requests.push(haxe_ds_Either.Right(view_shared_io_BinaryLoader.create("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "auth.User", action : "edit", filter : "user_name|" + this.props.user.user_name, dataSource : haxe_Serializer.run((__map_reserved["edit"] != null ? _this.getReserved("edit") : _this.h["edit"]).source), devIP : App.devIP},function(data) {
			haxe_Log.trace(Reflect.fields(data),{ fileName : "src/view/shared/io/User.hx", lineNumber : 122, className : "view.shared.io.User", methodName : "componentDidMount"});
			haxe_Log.trace(Reflect.fields(data.dataRows[0]),{ fileName : "src/view/shared/io/User.hx", lineNumber : 124, className : "view.shared.io.User", methodName : "componentDidMount"});
			...
			if((__map_reserved["change_pass_required"] != null ? _this1.getReserved("change_pass_required") : _this1.h["change_pass_required"]) == "1") {
				...
				var b1 = _gthis.props.formContainer.createStateValues(data.dataRows[0],(__map_reserved["changePassword"] != null ? _this3.getReserved("changePassword") : _this3.h["changePassword"]).view);
				_gthis.setState({ data : data1, action : "changePassword", fields : b, values : b1, loading : false});
				var b2 = App.store;
				var _this4 = data.dataRows[0];
				var b3 = __map_reserved["first_name"] != null ? _this4.getReserved("first_name") : _this4.h["first_name"];
				var _this5 = data.dataRows[0];
				var b4 = __map_reserved["last_name"] != null ? _this5.getReserved("last_name") : _this5.h["last_name"];
				var _gthis1 = _gthis.props.user.user_name;
				var _this6 = data.dataRows[0];
				var b5 = __map_reserved["email"] != null ? _this6.getReserved("email") : _this6.h["email"];
				var _this7 = data.dataRows[0];
				b2.dispatch(redux__$Redux_Action_$Impl_$.map(action_AppAction.User({ first_name : b3, last_name : b4, user_name : _gthis1, email : b5, pass : "", new_pass : "", new_pass_confirm : "", waiting : false, loggedIn : true, last_login : HxOverrides.strDate(__map_reserved["last_login"] != null ? _this7.getReserved("last_login") : _this7.h["last_login"])})));
			} else {
				var data2 = data.dataRows[0];
				var _this8 = _gthis.dataAccess;
				var b6 = (__map_reserved["edit"] != null ? _this8.getReserved("edit") : _this8.h["edit"]).view;
				var _this9 = _gthis.dataAccess;
				var b7 = _gthis.props.formContainer.createStateValues(data.dataRows[0],(__map_reserved["edit"] != null ? _this9.getReserved("edit") : _this9.h["edit"]).view);
				_gthis.setState({ data : data2, action : "edit", fields : b6, values : b7, loading : false});
				var _this10 = data.dataRows[0];
				haxe_Log.trace(HxOverrides.strDate(__map_reserved["last_login"] != null ? _this10.getReserved("last_login") : _this10.h["last_login"]),{ fileName : "src/view/shared/io/User.hx", lineNumber : 149, className : "view.shared.io.User", methodName : "componentDidMount"});
				var b8 = App.store;
				var _this11 = data.dataRows[0];
				var b9 = __map_reserved["first_name"] != null ? _this11.getReserved("first_name") : _this11.h["first_name"];
				var _this12 = data.dataRows[0];
				var b10 = __map_reserved["last_name"] != null ? _this12.getReserved("last_name") : _this12.h["last_name"];
				var _gthis2 = _gthis.props.user.user_name;
				var _this13 = data.dataRows[0];
				var b11 = __map_reserved["email"] != null ? _this13.getReserved("email") : _this13.h["email"];
				var _this14 = data.dataRows[0];
				b8.dispatch(redux__$Redux_Action_$Impl_$.map(action_AppAction.User({ first_name : b9, last_name : b10, user_name : _gthis2, email : b11, pass : "", waiting : false, loggedIn : false, last_login : HxOverrides.strDate(__map_reserved["last_login"] != null ? _this14.getReserved("last_login") : _this14.h["last_login"])})));
			}
		})));
	}
	,componentDidUpdate: function(prevProps,prevState) {
		haxe_Log.trace(App.store.getState().appWare.user.first_name,{ fileName : "src/view/shared/io/User.hx", lineNumber : 170, className : "view.shared.io.User", methodName : "componentDidUpdate"});
	...
	,changePassword: function(ev) {
		var _gthis = this;
		haxe_Log.trace(this.state.values.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 178, className : "view.shared.io.User", methodName : "changePassword"});
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/shared/io/User.hx", lineNumber : 179, className : "view.shared.io.User", methodName : "changePassword"});
		...
		haxe_Log.trace(App.store.getState().appWare.user,{ fileName : "src/view/shared/io/User.hx", lineNumber : 195, className : "view.shared.io.User", methodName : "changePassword"});
		var tmp5 = this.props.formContainer.requests;
		var b = "" + Std.string(App.config.api);
		var b1 = this.props.user.user_name;
		var b2 = this.props.user.jwt;
		...
		tmp5.push(haxe_ds_Either.Right(view_shared_io_BinaryLoader.create(b,{ user_name : b1, jwt : b2, className : "auth.User", action : "changePassword", new_pass : b3, pass : __map_reserved["pass"] != null ? _this9.getReserved("pass") : _this9.h["pass"], devIP : App.devIP},function(data) {
			haxe_Log.trace(Reflect.fields(data),{ fileName : "src/view/shared/io/User.hx", lineNumber : 209, className : "view.shared.io.User", methodName : "changePassword"});
			haxe_Log.trace(data,{ fileName : "src/view/shared/io/User.hx", lineNumber : 210, className : "view.shared.io.User", methodName : "changePassword"});
			if(data.dataErrors.keys().hasNext()) {
				haxe_Log.trace(data.dataErrors.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 213, className : "view.shared.io.User", methodName : "changePassword"});
			}
			...
			if((__map_reserved["changePassword"] != null ? _this10.getReserved("changePassword") : _this10.h["changePassword"]) == "OK") {
				haxe_Log.trace(shared_Utils.dynaMap(App.store.getState().appWare.user).toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 217, className : "view.shared.io.User", methodName : "changePassword"});
				var _this11 = _gthis.dataAccess;
				var b4 = (__map_reserved["edit"] != null ? _this11.getReserved("edit") : _this11.h["edit"]).view;
				var _gthis1 = _gthis.props.formContainer;
				var b5 = shared_Utils.dynaMap(App.store.getState().appWare.user);
				var _this12 = _gthis.dataAccess;
				var b6 = _gthis1.createStateValues(b5,(__map_reserved["edit"] != null ? _this12.getReserved("edit") : _this12.h["edit"]).view);
				_gthis.setState({ fields : b4, values : b6, loading : false});
			} else {
				haxe_Log.trace(data.dataErrors.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 224, className : "view.shared.io.User", methodName : "changePassword"});
			}
		})));
	}
	,edit: function(ev) {
		var _gthis = this;
		haxe_Log.trace("hi :)",{ fileName : "src/view/shared/io/User.hx", lineNumber : 231, className : "view.shared.io.User", methodName : "edit"});
		var _this = this.dataAccess;
		this.props.formContainer.requests.push(haxe_ds_Either.Left(view_shared_io_Loader.loadData("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "auth.User", action : "edit", filter : "user_name|" + this.props.user.user_name, dataSource : haxe_Serializer.run((__map_reserved["edit"] != null ? _this.getReserved("edit") : _this.h["edit"]).source)},function(data) {
			haxe_Log.trace(data,{ fileName : "src/view/shared/io/User.hx", lineNumber : 244, className : "view.shared.io.User", methodName : "edit"});
			if(data == null) {
				return;
			}
			var _this1 = data[0];
			if(__map_reserved["ERROR"] != null ? _this1.existsReserved("ERROR") : _this1.h.hasOwnProperty("ERROR")) {
				var _this2 = data[0];
				haxe_Log.trace(__map_reserved["ERROR"] != null ? _this2.getReserved("ERROR") : _this2.h["ERROR"],{ fileName : "src/view/shared/io/User.hx", lineNumber : 249, className : "view.shared.io.User", methodName : "edit"});
				return;
			}
			var _this3 = _gthis.dataAccess;
			var a = (__map_reserved["edit"] != null ? _this3.getReserved("edit") : _this3.h["edit"]).view;
			var _this4 = _gthis.dataAccess;
			var a1 = _gthis.props.formContainer.createStateValues(data[0],(__map_reserved["edit"] != null ? _this4.getReserved("edit") : _this4.h["edit"]).view);
	...
	,save: function(evt) {
		var _gthis = this;
		evt.preventDefault();
		haxe_Log.trace(this.state.data.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 266, className : "view.shared.io.User", methodName : "save"});
		haxe_Log.trace(this.state.values.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 267, className : "view.shared.io.User", methodName : "save"});
		var _this = this.dataAccess;
		...
		haxe_Log.trace(this.props.formContainer.filterMap(this.state.values,skeys).toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 270, className : "view.shared.io.User", methodName : "save"});
		haxe_Log.trace(skeys.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 271, className : "view.shared.io.User", methodName : "save"});
		var _this3 = this.dataAccess;
		haxe_Log.trace((__map_reserved["edit"] != null ? _this3.getReserved("edit") : _this3.h["edit"]).source.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 272, className : "view.shared.io.User", methodName : "save"});
		var _this4 = this.dataAccess;
		this.props.formContainer.requests.push(haxe_ds_Either.Left(view_shared_io_Loader.load("" + Std.string(App.config.api),{ user_name : this.props.user.user_name, jwt : this.props.user.jwt, className : "auth.User", action : "save", filter : "user_name|" + this.props.user.user_name, dataSource : haxe_Serializer.run((__map_reserved["edit"] != null ? _this4.getReserved("edit") : _this4.h["edit"]).source)},function(data) {
			haxe_Log.trace(data,{ fileName : "src/view/shared/io/User.hx", lineNumber : 287, className : "view.shared.io.User", methodName : "save"});
		})));
	}
	,updateMenu: function(viewClassPath) {
		var sideMenu = this.state.sideMenu;
	...
	,renderContent: function() {
		haxe_Log.trace(this.props.match.params.action,{ fileName : "src/view/shared/io/User.hx", lineNumber : 316, className : "view.shared.io.User", methodName : "renderContent"});
		switch(this.props.match.params.action) {
		case "changePassword":
		...
		case "edit":
			return this.props.formContainer.renderElements(this.state);
		default:
			return null;
		}
	}
	,renderErrors: function(name) {
		...
		haxe_Log.trace(name + ":" + Std.string(__map_reserved[name] != null ? _this.existsReserved(name) : _this.h.hasOwnProperty(name)),{ fileName : "src/view/shared/io/User.hx", lineNumber : 346, className : "view.shared.io.User", methodName : "renderErrors"});
	...
	,render: function() {
		if(this.state.values != null) {
			haxe_Log.trace(this.state.values.toString(),{ fileName : "src/view/shared/io/User.hx", lineNumber : 359, className : "view.shared.io.User", methodName : "render"});
		}
...
var view_table_Table = function(props) {
	...
	haxe_Log.trace(this.fieldNames,{ fileName : "src/view/table/Table.hx", lineNumber : 161, className : "view.table.Table", methodName : "new"});
...
view_table_Table.prototype = $extend(React_Component.prototype,{
	...
	,render: function() {
		if(this.props.data != null) {
			haxe_Log.trace(this.props.data.length,{ fileName : "src/view/table/Table.hx", lineNumber : 168, className : "view.table.Table", methodName : "render"});
		}
		haxe_Log.trace(this.props.className,{ fileName : "src/view/table/Table.hx", lineNumber : 169, className : "view.table.Table", methodName : "render"});
	...
	,renderHeaderRow: function() {
		...
		haxe_Log.trace(headerRow.length,{ fileName : "src/view/table/Table.hx", lineNumber : 238, className : "view.table.Table", methodName : "renderHeaderRow"});
		return headerRow;
	}
	...
	,renderRows: function(dRows) {
		...
		while(_g < dRows.length) {
			...
			if(row == 1) {
				haxe_Log.trace("<tr data-id=" + id + "< ke..",{ fileName : "src/view/table/Table.hx", lineNumber : 312, className : "view.table.Table", methodName : "renderRows"});
			}
		...
		haxe_Log.trace(dRs.length,{ fileName : "src/view/table/Table.hx", lineNumber : 320, className : "view.table.Table", methodName : "renderRows"});
		return dRs;
	}
	,select: function(mEv) {
		haxe_Log.trace(mEv.altKey,{ fileName : "src/view/table/Table.hx", lineNumber : 326, className : "view.table.Table", methodName : "select"});
		haxe_Log.trace(mEv.currentTarget,{ fileName : "src/view/table/Table.hx", lineNumber : 327, className : "view.table.Table", methodName : "select"});
	...
	,selectAltGroup: function(altGroupPos,cRow) {
		...
		while(_g < _g1) {
			...
			haxe_Log.trace(row.cells.item(altGroupPos).nodeValue + "==" + groupName,{ fileName : "src/view/table/Table.hx", lineNumber : 358, className : "view.table.Table", methodName : "selectAltGroup"});
	...
	,layOut: function() {
		var _gthis = this;
		haxe_Log.trace("firstCall: " + Std.string(this.headerUpdated) + " " + Std.string(this.tHeadRef) + ": " + Std.string(this.tHeadRef != null && react__$ReactRef_ReactRef_$Impl_$.get_current(this.tHeadRef) != null),{ fileName : "src/view/table/Table.hx", lineNumber : 382, className : "view.table.Table", methodName : "layOut"});
		if(this.tHeadRef == null || react__$ReactRef_ReactRef_$Impl_$.get_current(this.tHeadRef) == null) {
			haxe_Log.trace("" + Std.string(this.tHeadRef) + ": " + Std.string(this.tHeadRef != null && react__$ReactRef_ReactRef_$Impl_$.get_current(this.tHeadRef) != null),{ fileName : "src/view/table/Table.hx", lineNumber : 386, className : "view.table.Table", methodName : "layOut"});
			if(this._timer != null) {
				return;
			}
		...
		haxe_Log.trace(react__$ReactRef_ReactRef_$Impl_$.get_current(this.tableRef).offsetHeight,{ fileName : "src/view/table/Table.hx", lineNumber : 398, className : "view.table.Table", methodName : "layOut"});
		haxe_Log.trace(react__$ReactRef_ReactRef_$Impl_$.get_current(this.tableRef).offsetHeight,{ fileName : "src/view/table/Table.hx", lineNumber : 400, className : "view.table.Table", methodName : "layOut"});
		var i = 0;
		var grow = [];
		if(this.props.fullWidth) {
			...
			haxe_Log.trace(Std.string(grow) + ":" + growSum,{ fileName : "src/view/table/Table.hx", lineNumber : 418, className : "view.table.Table", methodName : "layOut"});
			if(growSum > 0) {
				...
				while(_g2 < _g3) {
					...
					if(grow[i1] != null && grow[i1] != 0) {
						haxe_Log.trace("" + i1 + " " + grow[i1] + " * " + growUnit + " + " + react__$ReactRef_ReactRef_$Impl_$.get_current(this.rowRef).children.item(i1).offsetWidth,{ fileName : "src/view/table/Table.hx", lineNumber : 428, className : "view.table.Table", methodName : "layOut"});
		...
		while(_g4 < _g11.length) {
			...
			haxe_Log.trace(w + ":" + cell1.clientWidth,{ fileName : "src/view/table/Table.hx", lineNumber : 440, className : "view.table.Table", methodName : "layOut"});
	...
	,componentDidMount: function() {
		...
		window.requestAnimationFrame(function(t) {
			haxe_Log.trace(t,{ fileName : "src/view/table/Table.hx", lineNumber : 452, className : "view.table.Table", methodName : "componentDidMount"});
			_gthis.layOut();
		});
	}
	,componentDidUpdate: function(prevProps,prevState) {
		haxe_Log.trace(Std.string(this.headerUpdated) + ":" + Std.string(this.tHeadRef),{ fileName : "src/view/table/Table.hx", lineNumber : 459, className : "view.table.Table", methodName : "componentDidUpdate"});
	...
	,componentWillUnmount: function() {
		haxe_Log.trace("leaving...",{ fileName : "src/view/table/Table.hx", lineNumber : 473, className : "view.table.Table", methodName : "componentWillUnmount"});
		if(this._timer != null) {
			this._timer.stop();
		}
	...
	,showDims: function(ref) {
		...
		while(_g < cells.length) {
			var cell = cells[_g];
			++_g;
			haxe_Log.trace(cell.getBoundingClientRect().toJSON(),{ fileName : "src/view/table/Table.hx", lineNumber : 486, className : "view.table.Table", methodName : "showDims"});
			s += cell.getBoundingClientRect().width;
		}
		haxe_Log.trace(" sum:" + s,{ fileName : "src/view/table/Table.hx", lineNumber : 489, className : "view.table.Table", methodName : "showDims"});
	}
	,nodeDims: function(n) {
		var i = 0;
		var s = 0;
		...
		while(_g < cells.length) {
			...
			haxe_Log.trace(dRect,{ fileName : "src/view/table/Table.hx", lineNumber : 500, className : "view.table.Table", methodName : "nodeDims"});
			s += (js_Boot.__cast(cell , HTMLElement)).getBoundingClientRect().width;
		}
		haxe_Log.trace(" sum:" + s,{ fileName : "src/view/table/Table.hx", lineNumber : 504, className : "view.table.Table", methodName : "nodeDims"});
	}
...
view_dashboard_Roles._connected = (redux_react_ReactRedux.connect(view_dashboard_Roles.mapStateToProps))(react__$ReactType_ReactType_$Impl_$.fromComp(view_dashboard_Roles));
view_dashboard_Roles.__jsxStatic = view_dashboard_Roles._connected;
...
view_shared_SMenu._connected = (redux_react_ReactRedux.connect())(react__$ReactType_ReactType_$Impl_$.fromComp(view_shared_SMenu));
view_shared_SMenu.__jsxStatic = view_shared_SMenu._connected;
view_shared_io_Bookmarks.menuItems = [{ label : "Neu", action : "create"},{ label : "Bearbeiten", action : "edit"},{ label : "Speichern", action : "save"},{ label : "Löschen", action : "delete"}];
...
view_shared_io_DB.menuItems = [{ label : "Create Fields Table", action : "createFieldList"},{ label : "Table Fields", action : "showFieldList"},{ label : "Bearbeiten", action : "editTableFields"},{ label : "Speichern", action : "save"},{ label : "Löschen", action : "delete"}];
view_shared_io_DBSync.menuItems = [{ label : "Create Fields Table", action : "createFieldList"},{ label : "BenutzerDaten Abgleich", action : "showUserList"},{ label : "Speichern", action : "save"},{ label : "Löschen", action : "delete"}];
...
view_shared_io_FormContainer.ky = shared_Utils.genKey;
...
view_shared_io_Users.menuItems = [{ label : "Liste", action : "show"},{ label : "Neu", action : "create"},{ label : "Bearbeiten", action : "edit"},{ label : "Speichern", action : "save"},{ label : "Löschen", action : "delete"}];
Go.main();
